...
func (self *FormatEXT2) erase_pointer_block_content(pointer_block *types.PointerBlock, level int32,till int32){
...
func (self *FormatEXT2) write_file_content_in_pointer(pointer_block *types.PointerBlock, level int32,at *int32, data *[]string){
	if level != 0 { //recursive thing
...
func (self *FormatEXT2) Update_file(file_inode *types.IndexNode,at int32, data []string){
...
func (self *FormatEXT2) read_file_content_in_pointer(pointer_block *types.PointerBlock, level int32, amout *int32, data *[]string){
	if level != 0 { //recursive thing
...
func (self *FormatEXT2) Read_file(file_inode *types.IndexNode)[]string{
